...
export declare class categoryController {
    ...
    createProductCategory(categoryDto: categoryDto): Promise<Category | string>;
    updateProduct(id: string, updateProductCategoryDto: updateProductCategoryDto): Promise<object>;
